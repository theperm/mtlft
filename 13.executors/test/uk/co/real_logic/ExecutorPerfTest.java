...
public class ExecutorPerfTest
{
    ...
    public static void main(final String[] args)
        throws Exception
    {
        ExecutorPerfTest test = new ExecutorPerfTest();
    ...
    public void shouldPerformanceTestOfferAndPoll()
        throws Exception
    {
        final ThreadPoolExecutor executor = new ThreadPoolExecutor(THREAD_POOL_SIZE, QUEUE_CAPACITY);
    ...
    private void perfRun(final int runNum, final ThreadPoolExecutor executor)
        throws Exception
    {
